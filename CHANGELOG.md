...
### Fixed
  ...
  - (Backported from 2.0.6) Crash during copy of complex data types (e.g., Date) from one table to another. This was due to proxied data types not providing a bound reference to the toJSON() method of their targets when being serialised. (#14)
